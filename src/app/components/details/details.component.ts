...
export class DetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(private activatedRouter: ActivatedRoute, public weather: WeatherService) {
  }
  ...
  ngOnInit() {
    ...
    this.activatedRouter.paramMap.subscribe((route: any) => {
      ...
      this.sub3 = this.weather.getCurrentHum(this.city).subscribe((humidity) => this.humidity = humidity);
